...
| **Ventas** | Histórico de vehículos retirados del inventario oficial (≈ vendidos/reservados; si reaparecen dejan de contar). KPIs: modelo y coche más vendidos, país, mediana de días en venta, precio medio; gráfica apilada por modelo (mes / semana / día); tabla con versión, año, km, último precio (e inicial), días en venta. Respeta los filtros. Datos desde el primer refresco (17/08/2026); fuente `public/data/sales.json`, generada desde `data/tracking.json`. |
